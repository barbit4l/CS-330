...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/red.jpg", "red");
	bReturn = CreateGLTexture(
		"textures/mushroom.jpg", "mushroom");
	bReturn = CreateGLTexture(
		"textures/wood.png", "wood");
	bReturn = CreateGLTexture(
		"textures/lightwood.jpg", "house");
	bReturn = CreateGLTexture(
		"textures/grass.jpg", "grass");
...
void SceneManager::DefineObjectMaterials()
{
	...
	treeMaterial.ambientColor = glm::vec3(0.2f, 0.2f, 0.2f);
	treeMaterial.ambientStrength = 0.8f;
	treeMaterial.diffuseColor = glm::vec3(0.5f, 0.5f, 0.5f);
	treeMaterial.specularColor = glm::vec3(0.3f, 0.3f, 0.3f);
...
void SceneManager::SetupSceneLights()
{
	...
	// REALLY STRUGGLING WITH LIGHT PLACEMENT
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 5.0f, 6.0f, 10.0f); 
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.01f, 0.02f, 0.01f); 
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", -5.0f, 6.0f, 10.0f); 
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 4.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 0.0f, 4.0f);
	...
	SetShaderColor(0.498, 0.498, 0.498, 1);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 4.0f, 4.0f);
	...
	// SetShaderColor(0.690, 0.133, 0.133, 1);
	SetShaderTexture("mushroom");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("tree");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(10.0f, 8.0f, 7.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 4.0f, -3.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(11.0f, 7.0f, 10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 11.0f, -3.0f);
